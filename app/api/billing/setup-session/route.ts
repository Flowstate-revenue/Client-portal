...
// Portal -> Stripe hosted card capture. Verifies the session, resolves the
// caller's client, and asks the stripe-setup-session Edge Function for a hosted
// Checkout URL. No Stripe keys and no card data in this app.
export async function POST(request: Request) {
  ...
  // client_owner uses their own client; an admin may pass a client_id (view-as)
  ...
  const fnUrl = process.env.STRIPE_SETUP_FN_URL
